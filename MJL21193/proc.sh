...
csvtotable parameters.csv parameters.html --caption "MJL21193 Parameters" --overwrite
csvtotable curvematch.csv curvematch.html --caption "MJL21193 Curve Matching" --overwrite
cp ../_tools/index_template.html ./
mv index_template.html index.html
sed -i 's/TEMPLATE/MJL21193/g' index.html
