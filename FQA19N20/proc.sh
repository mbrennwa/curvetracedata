...
csvtotable parameters.csv parameters.html --caption "FQA19N20 Parameters" --overwrite
csvtotable curvematch.csv curvematch.html --caption "FQA19N20 Curve Matching" --overwrite
cp ../_tools/index_template.html ./
mv index_template.html index.html
sed -i 's/TEMPLATE/FQA19N20/g' index.html
